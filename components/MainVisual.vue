<template>
  <section class="relative w-full h-[85vh] overflow-hidden flex justify-start bg-gray-100 px-0 pb-30">
    ...
    <div class="absolute top-0 left-0 w-full h-full">
      <img src="~/public/images/IMG_3473.jpg" alt="Main Visual" class="w-full h-full object-cover md:hidden" />
      <img src="~/public/images/IMG_3473.jpg" alt="Main Visual" class="hidden md:block w-full h-full object-cover" />
    </div>
  </section>
</template>
